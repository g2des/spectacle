...
News are everywhere- TV, newspapers, social media. We consume it whether we like it or not. But the question is, how do we know which news are true, and which are false? 
$\newline$
Fake news has been a real issue since the spark of social media, especially in the recent years, with its spike coming during the 2016 US presidential election. In fact, a study from Ohio State University shows that fake news had a significant impact on the results of the elections. The researchers found a correlation between the amount of Obama voters who believed fake news about Clinton and the amount of them who chose to vote for Trump. At that time, the media was swarmed with fake news, and one could hardly blame people who couldn't distinguish them from real news.
...
Detecting fake news is quite a challenge, as its main goal is to persuade consumers to accept biased or false beliefs.
\section{Background}
%\label{sec:headings}
